// Sidebar navigation item configuration (icon paths + active-route matchers).
// Extracted from AuthenticatedLayout.vue (P2-9) so the layout is no longer a
// monolith and the nav config can be reused/tested in isolation.
