    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-semibold text-2xl text-gray-900 dark:text-gray-100">{{ t('reportBuilder.editReport') }}</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ report.name }}</p>
                </div>
                <Link
