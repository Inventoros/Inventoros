        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <svg
                                                ...
                                                class="w-4 h-4 text-red-600 dark:text-red-400 ml-1"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                    ...
                    <!-- Pagination -->
                    <div v-if="products.data.length > 0" class="bg-white dark:bg-gray-800 px-4 py-3 border-t border-gray-200 dark:border-gray-700 sm:px-6">
                        <div class="flex items-center justify-between">
