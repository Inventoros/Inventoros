        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 mb-6 sm:grid-cols-2 lg:grid-cols-4">
                    <!-- Total Products -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-primary-400/50 transition">
                        <div class="p-6">
                    ...
                    <!-- Low Stock -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-red-400/50 transition">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <!-- Categories -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-accent-purple/50 transition">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <!-- Total Orders -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-primary-400/30 transition">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-primary-400/30 transition">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-400">Revenue This Month</p>
                                    <p class="text-2xl font-semibold text-gray-100">
                ...
                <div class="grid grid-cols-1 gap-6 mb-6 sm:grid-cols-2 lg:grid-cols-5">
                    <!-- Pending Orders -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-amber-400/30 transition">
                        <Link :href="route('orders.index', { status: 'pending' })" class="block p-4">
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Pending Orders</p>
                    ...
                    <!-- Categories -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-accent-purple/30 transition">
                    ...
                    <!-- Locations -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-orange-400/30 transition">
                        <Link :href="route('locations.index')" class="block p-4">
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Locations</p>
                    ...
                    <!-- Inventory Value -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-green-400/30 transition">
                        <div class="p-4">
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Inventory Value</p>
                    ...
                    <!-- Low Stock Alert -->
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-red-400/30 transition">
                        <Link :href="route('products.index', { low_stock: '1' })" class="block p-4">
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Low Stock Items</p>
                    ...
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-primary-400/30 transition">
                        <div class="p-6">
                            ...
                            <div v-if="recentOrders.length === 0" class="text-center py-8">
                                ...
                                <p class="text-gray-400 mb-3">No orders yet</p>
                                <Link
                            ...
                            <div v-else class="space-y-3">
                                <div
                                    ...
                                    :key="order.id"
                                    class="flex items-center justify-between p-3 bg-dark-bg/50 rounded-lg border border-dark-border hover:border-primary-400/30 transition cursor-pointer"
                    ...
                    <div class="bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-primary-400/30 transition">
                        <div class="p-6">
                            ...
                            <div v-if="recentProducts.length === 0" class="text-center py-8">
                                ...
                                <p class="text-gray-400 mb-3">No products yet</p>
                                <Link
                            ...
                            <div v-else class="space-y-3">
                                <div
                                    ...
                                    :key="product.id"
                                    class="flex items-center justify-between p-3 bg-dark-bg/50 rounded-lg border border-dark-border hover:border-primary-400/30 transition"
                                >
                                    <div class="flex-1">
                                        <p class="font-medium text-gray-100">
                                            {{ product.name }}
                ...
                <!-- Stock by Category -->
                <div v-if="stockByCategory.length > 0" class="mt-6 bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg hover:border-accent-purple/30 transition">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div
                                ...
                                :key="category.name"
                                class="p-4 bg-dark-bg/50 rounded-lg border border-dark-border hover:border-accent-purple/30 transition"
                            >
                                <p class="font-medium text-gray-100 mb-1">
                                    {{ category.name }}
                                </p>
                                <p class="text-2xl font-semibold text-gray-100">
                ...
                <!-- Quick Actions -->
                <div class="mt-6 bg-dark-card border border-dark-border overflow-hidden shadow-lg sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-100 mb-4">
                            Quick Actions
                        </h3>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            >
                                ...
                                <div class="ml-3">
                                    <p class="font-semibold text-gray-100">Create Order</p>
                                    <p class="text-sm text-gray-400">New order</p>
                                </div>
                            </Link>
                            ...
                            >
                                ...
                                <div class="ml-3">
                                    <p class="font-semibold text-gray-100">Add Product</p>
                                    <p class="text-sm text-gray-400">Create new item</p>
                                </div>
                            </Link>
                            ...
                            >
                                ...
                                <div class="ml-3">
                                    <p class="font-semibold text-gray-100">View Inventory</p>
                                    <p class="text-sm text-gray-400">Browse all items</p>
                                </div>
                            </Link>
                            ...
                            >
                                ...
                                <div class="ml-3">
                                    <p class="font-semibold text-gray-100">View Orders</p>
