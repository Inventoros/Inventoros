...
/**
 * Validates creating a webhook (web). Rules unchanged from
 * WebhookController::store, including the SSRF guard rejecting local/metadata
 * and private/reserved IP targets.
 */
